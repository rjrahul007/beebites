...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Typical delivery time is 30-45 minutes, depending on your location and the restaurant's preparation time. You can track your order in real-time through the webapp.",
      },
      {
        q: "What areas do you deliver to?",
        a: "We currently deliver across major areas in Dimapur, Nagaland.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Contact our support team immediately through the webapp or email. We'll work to resolve the issue and may offer a refund or replacement.",
      },
      {
        q: "What if an item is missing from my order?",
        a: "Please report missing items through the webapp within 30 minutes of delivery. Our team will investigate and provide an appropriate resolution.",
      },
    ],
  },
  {
