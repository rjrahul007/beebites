        ...
        <div className="bg-card rounded-xl shadow-xl p-6 sm:p-10 border border-border">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-foreground/90 mb-6">
              Welcome to Beebites! These Terms govern your use of our platform.
              By accessing or using Beebites, you agree to these Terms.
            </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-foreground/90">
                All payments are online — UPI, credit or debit cards, etc.
                Payment authorization must be valid and complete at the time of
                order.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-foreground/90">
                All content on Beebites (logos, text, graphics) is owned by us
                or our licensors.
              </p>
            </section>
