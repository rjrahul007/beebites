      ...
      <div className="bg-card rounded-xl shadow-xl p-6 sm:p-10 border border-border mb-2">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-foreground/90 mb-6">
            Beebites ("we", "us", "our") respects your privacy and is committed
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/90 mb-4">
              ...
              <li>Communication you send to us (feedback, support messages)</li>
            </ul>
            <p className="text-foreground/90 mb-3">
              We also automatically collect:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-foreground/90">
              <li>Device & usage data (like IP, browser, app interactions)</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/90">
              ...
              payments (UPI, credit/debit card). Beebites never directly stores
              full card numbers; this is managed by compliant payment gateways.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/90">
              ...
              <li>Service providers (for analytics, customer support, etc.)</li>
