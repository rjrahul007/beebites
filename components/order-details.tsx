        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <StatusRow
                active={order.status === ORDER_STATUS.DELIVERED}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {order.special_instructions && (
                <>
                  <Separator />
                  <InfoRow label="Special Instructions">
                    {order.special_instructions}
                  </InfoRow>
                </>
              )}
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              {order.status === ORDER_STATUS.PAYMENT_FAILED && (
                <Button className="w-full mt-4" onClick={handleRetry}>
...
function StatusRow({
  ...
  return (
    <div className={`flex gap-4 ${active ? "" : "text-muted-foreground"}`}>
      <div
        className={`flex h-10 w-10 items-center justify-center rounded-full ${
